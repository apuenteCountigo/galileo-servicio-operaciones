...
public class OperacionesOrquestador {
    ...
    // public void iniciarCreacionOperacion(Operaciones operacion) throws
    ...
    // } catch (Exception e) {
    // log.error("Error, send crear-operacion-dma");
    ...
    // public void manejarTraccarCreado(String mensaje) throws
    // JsonProcessingException {
    ...
    // @KafkaListener(topics = { "dma-error", "traccar-error",
